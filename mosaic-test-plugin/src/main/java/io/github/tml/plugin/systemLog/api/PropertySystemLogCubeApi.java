...
@MExtensionPackage(value = "system.log",
        ...
        version = "1.0.1",
        cubeId = PLUGIN_ID_P)
public class PropertySystemLogCubeApi extends ExtensionPackage<PropertySystemLogCube> {


    public PropertySystemLogCubeApi(PropertySystemLogCube cube, GUID guid) {
        super(cube, guid);
    }
