                ...
                <v-row class="mt-6">
                  <v-col cols="12" md="6">
                    <div class="minecraft-section">
                      ...
                      <div class="minecraft-status-item">
                        <span>⚡ TPS:</span>
                        <strong :class="{ 'text-success': serverInfo.tps >= 19, 'text-warning': serverInfo.tps < 19 && serverInfo.tps >= 15, 'text-error': serverInfo.tps < 15 }">
                          {{ serverInfo.tps }}
                        </strong>
                      </div>
                      <div class="minecraft-status-item">
...
.text-success { color: var(--mc-emerald) !important; }
.text-warning { color: var(--mc-gold) !important; }
.text-error { color: var(--mc-redstone) !important; }
